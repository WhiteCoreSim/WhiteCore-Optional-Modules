...
namespace WhiteCore.Addon.AdvancedCurrency
{
    class GiveStipends
    {
        ...
        private AdvancedCurrencyConfig m_options;
        readonly IScheduleService m_scheduler;
        private readonly IRegistryCore m_registry;
        private readonly AdvancedCurrencyConfig m_currencyService;

        public GiveStipends(AdvancedCurrencyConfig options, IRegistryCore registry, AdvancedCurrencyConnector dustCurrencyService)
        {
