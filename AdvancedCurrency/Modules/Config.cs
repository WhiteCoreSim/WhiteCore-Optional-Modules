...
{
    public class AdvancedCurrencyConfig : IDataTransferable
    {
        #region declarations
        ...
        public AdvancedCurrencyConfig(IConfig economyConfig)
        {
        ...
        public AdvancedCurrencyConfig()
        {
        }

        public AdvancedCurrencyConfig(OSDMap values)
        {
            FromOSD(values);
        }
