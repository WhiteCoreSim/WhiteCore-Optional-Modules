...
{
    public class AdvancedCurrencyConnector : ConnectorBase, IAdvancedCurrencyConnector
    {
        #region Declares
        ...
        public string Name
        {
            get { return "IAdvancedCurrencyConnector"; }
        }
                               ...
                               string defaultConnectionString)
        {
            ...
            if (config == null || source.Configs["Currency"].GetString("Module", "") != "AdvancedCurrency")
                return;
