...
namespace LandscapeGenCore
{
    ...
    {
        int _numberOfOctaves = 5;
        double _persistence = 0.7d;
        int _resultX = 200;
        int _resultY = 200;
        int _corsenessX = 10;
        int _corsenessY = 10;
        ...
        [Category ("General"), Description ("Edges will be zero or less.")]
        public bool FlatEdges {
            get { return _flatEdges; }
            set { _flatEdges = value; }
        }

        [Category ("General"), Description ("Inital seed for random number generator. Zero means it is taken from the clock.")]
        public int RandomSeed {
            get { return _randomSeed; }
            set { _randomSeed = value; }
        }

        [Category ("General"), Description ("Number of interations that will be run. More generates a finer noise.")]
        public int Octaves {
            get { return _numberOfOctaves; }
            set { _numberOfOctaves = value; }
        }

        [Category ("General"), Description ("Persistence.")]
        ...
        [Category ("Corseness"), Description ("Corseness on X.")]
        ...
        [Category ("Corseness"), Description ("Corseness on Y.")]
    ...
    public class PerlinNoise : INoiseGenerator
    {
        ...
        int [] _Primes = {
            10719073,10719077,10719089,10719109,10719113,10719119,10719139,10719143,
        ...
        double Noise_2D (int octave, int x, int y)
        {
        ...
        double SmoothNoise_2D (int octave, int x, int y)
        {
            double corners;
            double sides;
            double center;
        ...
        double InterpolatedNoise_2D (int octave, double x, double y)
        {
        ...
        double PerlinNoise_2D (double x, double y, int Number_Of_Octaves, double persistence)
        {
