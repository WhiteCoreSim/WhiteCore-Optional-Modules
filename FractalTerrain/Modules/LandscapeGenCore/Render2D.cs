...
namespace LandscapeGenCore
{
    ...
    {
        TerranValues _settings;
        float _boundsMin = float.MinValue;
        float _boundsMax = float.MaxValue;
        ...
        Color ScaleGreyscale (float val)
        {
            int grey;
            float newVal;
        ...
        Color ScaleThreeColor (float val, Color color1, Color color2, Color color3)
        {
            int red;
            int green;
            int blue;
            ...
            if (Math.Abs (val - _boundsMin) < GlobalVar.EPSILON) {
                // 100% Color 1
                red = color1.R;
                green = color1.G;
                blue = color1.B;

            } else if (Math.Abs (val - midPoint) < GlobalVar.EPSILON) {
                // 100% Color 2
                red = color2.R;
                green = color2.G;
                blue = color2.B;

            } else if (Math.Abs (val - _boundsMax) < GlobalVar.EPSILON) {
                // 100% Color 3
                red = color3.R;
                green = color3.G;
                blue = color3.B;
        ...
        Color ScaleTwoColor (float val, Color color1, Color color2)
        {
            float bios;
            bios = val / (_boundsMax - _boundsMin);
